...
import com.example.miocard.presentation.viewmodel.CreateCardViewModel
...
fun CreateCardScreen(
    ...
    // Navigate back when card is created
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                ...
                Text(
                    if (uiState.isLoading) stringResource(R.string.creating_card)
                    else stringResource(R.string.create_card_button)
                )
            }
